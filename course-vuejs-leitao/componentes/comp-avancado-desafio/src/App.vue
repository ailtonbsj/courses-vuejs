<template>
  <div id="app">
    <span>
      <button class="vermelho" @click="cor = 'Vermelho'">
        Carregar Componente Vermelho
      </button>
      <button class="verde" @click="cor = 'Verde'">
        Carregar Componente Verde
      </button>
      <button class="azul" @click="cor = 'Azul'">
        Carregar Componente Azul
      </button>
    </span>

    <component :is="cor">
      <div slot="Vermelho">Conteúdo do Componente <strong>Vermelho</strong></div>
      <div slot="Verde">Conteúdo do Componente <em>Verde</em></div>
      <div slot="Azul">Conteúdo do Componente <u>Azul</u></div>
    </component>
  </div>
</template>
